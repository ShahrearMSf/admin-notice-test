...
| 12 | Design | Font family | `<expected>` | `<actual>` | |
| 13 | Design | Body font size | `<expected>` | `<actual>` | |
| 14 | Design | Body line-height | `<expected>` | `<actual>` | |
| 15 | Design | Body font weight | `<expected>` | `<actual>` | |
